package me.ling.horizons.commonImpl.configuration;
...
import me.ling.horizons.common.util.MultiGson;
...
public class LingConfigStore {
    private final MultiGson gson;

    private LingConfigStore(Object... defaultValues) {
