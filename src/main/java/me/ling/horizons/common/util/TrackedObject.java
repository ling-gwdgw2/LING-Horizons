...
import static me.ling.horizons.common.util.GlobalCleaner.CLEANER;

public abstract class TrackedObject {
    //TODO: maybe make this false? for performance overhead?
    public static final boolean TRACK_OBJECT_ALLOCATIONS = LingCommon.isVerificationFlagOn("ensureTrackedObjectsAreFreed", true);
    public static final boolean TRACK_OBJECT_ALLOCATION_STACKS = LingCommon.isVerificationFlagOn("trackObjectAllocationStacks");
