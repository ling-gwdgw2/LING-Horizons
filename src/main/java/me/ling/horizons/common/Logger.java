package me.ling.horizons.common;
...
public class Logger {
    ...
    private static final org.slf4j.Logger LOGGER = LoggerFactory.getLogger("ling_horizons");
    ...
    public static void error(Object... args) {
        ...
        if (LingCommon.IS_IN_MINECRAFT && !LingCommon.IS_DEDICATED_SERVER) {
