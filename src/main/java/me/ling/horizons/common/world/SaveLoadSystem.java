package me.ling.horizons.common.world;
...
public class SaveLoadSystem {
    public static final boolean VERIFY_HASH_ON_LOAD  = LingCommon.isVerificationFlagOn("verifySectionHash");
    public static final boolean VERIFY_MEMORY_ACCESS = LingCommon.isVerificationFlagOn("verifyMemoryAccess");
