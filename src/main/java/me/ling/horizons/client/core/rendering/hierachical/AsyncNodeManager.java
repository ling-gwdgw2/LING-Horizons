package me.ling.horizons.client.core.rendering.hierachical;
...
import me.ling.horizons.client.core.rendering.GeometryCache;
import me.ling.horizons.client.core.rendering.SectionUpdateRouter;
...
import me.ling.horizons.client.core.rendering.section.geometry.BasicAsyncGeometryManager;
...
public class AsyncNodeManager {
    ...
    private final Shader scatterWrite = Shader.make()
            ...
            .add(ShaderType.COMPUTE, "ling_horizons:util/scatter.comp")
            .compile();
    ...
    private final Shader multiMemcpy = Shader.make()
            ...
            .add(ShaderType.COMPUTE, "ling_horizons:util/memcpy.comp")
            .compile();
