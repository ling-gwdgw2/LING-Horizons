package me.ling.horizons.client.core.rendering;
...
public class ChunkBoundRenderer {
    ...
    public ChunkBoundRenderer(AbstractRenderPipeline pipeline) {
        ...
        String vert = ShaderLoader.parse("ling_horizons:chunkoutline/outline.vsh");
        ...
        this.rasterShader = Shader.makeAuto()
                ...
                .add(ShaderType.FRAGMENT, "ling_horizons:chunkoutline/outline.fsh")
                .compile()
    ...
    public void render(Viewport<?> viewport) {
        ...
        {//This is recomputed to be in chunk section space not worldsection
            ...
            MemoryUtil.memPutInt(ptr, LingConfig.CONFIG.lodBoundaryBuffer); ptr += 4;
        }
