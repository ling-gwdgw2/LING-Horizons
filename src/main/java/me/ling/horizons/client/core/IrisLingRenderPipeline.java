...
public class IrisLingRenderPipeline extends AbstractRenderPipeline {
    private final IrisLingRenderPipelineData data;
    private final FullscreenBlit depthBlit = new FullscreenBlit("ling_horizons:post/blit_texture_depth_cutout.frag");
    public final DepthFramebuffer fbTranslucent = new DepthFramebuffer(this.fb.getFormat());

    private final GlBuffer shaderUniforms;

    public IrisLingRenderPipeline(IrisLingRenderPipelineData data, AsyncNodeManager nodeManager, NodeCleaner nodeCleaner, HierarchicalOcclusionTraverser traversal, BooleanSupplier frexSupplier) {
