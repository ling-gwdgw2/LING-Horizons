...
import me.ling.horizons.client.core.rendering.post.FullscreenBlit;
import me.ling.horizons.client.core.rendering.section.backend.AbstractSectionRenderer;
import me.ling.horizons.client.core.rendering.util.DepthFramebuffer;
...
public abstract class AbstractRenderPipeline extends TrackedObject {
    ...
    private final FullscreenBlit depthMaskBlit = new FullscreenBlit("ling_horizons:post/fullscreen2.vert", "ling_horizons:post/noop.frag");
    private final FullscreenBlit depthSetBlit = new FullscreenBlit("ling_horizons:post/fullscreen2.vert", "ling_horizons:post/depth0.frag");
    private final FullscreenBlit depthCopy = new FullscreenBlit("ling_horizons:post/fullscreen2.vert", "ling_horizons:post/depth_copy.frag");
    ...
    public void runPipeline(Viewport<?> viewport, int sourceFrameBuffer, int srcWidth, int srcHeight) {
        ...
        var occlusionDebug = LingClient.getOcclusionDebugState();
        if (occlusionDebug==0) {
    ...
    protected void initDepthStencil(int sourceFrameBuffer, int targetFb, int srcWidth, int srcHeight, int width, int height) {
        ...
        if (!me.ling.horizons.client.core.util.IrisUtil.irisShaderPackEnabled()) {
