...
public class DebugRenderer {
    private final Shader debugShader = Shader.make()
            .add(ShaderType.VERTEX, "ling_horizons:lod/hierarchical/debug/node_outline.vert")
            .add(ShaderType.FRAGMENT, "ling_horizons:lod/hierarchical/debug/frag.frag")
            .compile();
    private final Shader setupShader = Shader.make()
            .add(ShaderType.COMPUTE, "ling_horizons:lod/hierarchical/debug/setup.comp")
            .compile();
