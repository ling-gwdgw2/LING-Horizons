...
import me.ling.horizons.client.core.gl.shader.AutoBindingShader;
...
import static me.ling.horizons.client.core.rendering.util.PrintfDebugUtil.PRINTF_processor;
...
public class HierarchicalOcclusionTraverser {
    ...
    private final AutoBindingShader traversal = Shader.makeAuto(PRINTF_processor)
            ...
            .add(ShaderType.COMPUTE, "ling_horizons:lod/hierarchical/traversal_dev.comp")
            .compile();
    ...
    private void uploadUniform(Viewport<?> viewport) {
        ...
        final float screenspaceAreaDecreasingSize = LingConfig.CONFIG.subDivisionSize*LingConfig.CONFIG.subDivisionSize;
