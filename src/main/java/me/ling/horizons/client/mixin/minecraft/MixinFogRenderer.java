 ...
 * The actual fog manipulation (save-restore pattern) is done in LingRenderSystem.renderOpaque()
...
public class MixinFogRenderer {
    // No injections needed - LingRenderSystem handles fog save-restore directly
}
