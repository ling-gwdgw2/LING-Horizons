...
import me.ling.horizons.client.mixin.iris.CustomUniformsAccessor;
import me.ling.horizons.client.mixin.iris.IrisRenderingPipelineAccessor;
...
public class IrisLingRenderPipelineData {
    public IrisLingRenderPipeline thePipeline;
    ...
    private IrisLingRenderPipelineData(IrisShaderPatch patch, int[] opaqueDrawTargets, int[] translucentDrawTargets, StructLayout uniformSet, Runnable blendingSetup, ImageSet imageSet, SSBOSet ssboSet) {
    ...
    public static IrisLingRenderPipelineData buildPipeline(IrisRenderingPipeline ipipe, IrisShaderPatch patch, CustomUniforms cu, ShaderStorageBufferHolder ssboHolder) {
        ...
        return new IrisLingRenderPipelineData(patch, opaqueDrawTargets, translucentDrawTargets, uniforms, patch.createBlendSetup(), imageSet, ssboSet);
    }
